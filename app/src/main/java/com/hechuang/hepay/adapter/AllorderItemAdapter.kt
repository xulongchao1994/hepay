...
class AllorderItemAdapter(val mContext: Context, val itemdata: List<AllorderBean.DataBean.ListBean.OrderdetailBean>) :
        RecyclerView.Adapter<AllorderItemAdapter.AllorderitemViewholder>() {
    ...
    override fun onBindViewHolder(holder: AllorderitemViewholder, position: Int) {
        ...
        holder.proname.text = itemdatas.supplier
