...
public class AlliancesshopTextView extends android.support.v7.widget.AppCompatTextView {
    /**
     * 文字长度
     */
    ...
    public AlliancesshopTextView(Context context) {
        super(context);
    }

    public AlliancesshopTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public AlliancesshopTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
